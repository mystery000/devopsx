...
def prompt_full(interactive: bool) -> Generator[Message, None, None]:
    ...
    yield from prompt_devopsx(interactive)
...
def prompt_devopsx(interactive: bool) -> Generator[Message, None, None]:
    """
    Base system prompt for devopsx.

    It should:
     - Introduce devopsx and its general capabilities and purpose
    ...
    base_prompt = f"""
You are devopsx v{__version__}, a general-purpose AI assistant powered by LLMs.
